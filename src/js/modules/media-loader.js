...
<div class="medialoader">
	<div class="mediaload-area">
	
		<div class="mediaload-banner">
		<div class="mediaload-banner_icon">
		<svg class="icon icon--pre-photo">
		<use href="./icons/symbol/sprite.svg#pre-photo"></use>
	</svg>
	</div>									
		<input type="file" id="seller-personal-media" multiple accept="image/jpeg, image/png" class="hidden" />											
		</div>
		<div class="mediaload-previews"></div>
			</div>
	<div id="advertising-mediaload-warning" class="mediaload-warning hidden">
			JavaScript there paste text
	</div>
</div>
*/
